...
import com.example.player.databinding.FragmentFragmentsBinding
...
class FragmentsFragment : Fragment() {
    ...
    private var runnable = object : Runnable {
        override fun run() {
            ...
            if (mediaPlayer!!.currentPosition == mediaPlayer!!.duration || mediaPlayer!!.duration - mediaPlayer!!.currentPosition <=500){
                fragmentFragmentsBinding.right.callOnClick()
            }
        }
